...
export class LevelTut4 extends Phaser.Scene {
    ...
    public pFunction3 = {add: 3 , multi: 1};
    public pFunction4 = {add: 11 , multi: 1};
    ...
    create(): void {
        ...
        this.add.text(this.sys.game.canvas.width - 180, 187 + 100 * 3, "+" + this.pFunction4.add, {font: "25px Arial"});
